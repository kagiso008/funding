...
class CalculateCUTAPSPage extends StatefulWidget {
  const CalculateCUTAPSPage({super.key});

  @override
  _CalculateCUTAPSPageState createState() => _CalculateCUTAPSPageState();
}

class _CalculateCUTAPSPageState extends State<CalculateCUTAPSPage> {
  ...
  Future<void> _fetchUserMarks() async {
    try {
      ...
      setState(() {
        ...
        aps = _CalculateCUTAPS(userMarks);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT CUT"),
