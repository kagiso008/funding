...
class CalculateDUTAPSPage extends StatefulWidget {
  const CalculateDUTAPSPage({super.key, required});

  @override
  _CalculateDUTAPSPageState createState() => _CalculateDUTAPSPageState();
}

class _CalculateDUTAPSPageState extends State<CalculateDUTAPSPage> {
  ...
  Future<void> _fetchUserMarks() async {
    try {
      ...
      setState(() {
        ...
        aps = _CalculateDUTAPS(userMarks);
        isLoading = false;
      });
    } catch (error) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT DUT"),
