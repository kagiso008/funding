...
class CalculateMUTAPSPage extends StatefulWidget {
  const CalculateMUTAPSPage({super.key, required});

  @override
  _CalculateMUTAPSPageState createState() => _CalculateMUTAPSPageState();
}

class _CalculateMUTAPSPageState extends State<CalculateMUTAPSPage> {
  ...
  Future<void> _fetchUserMarks() async {
    try {
      ...
      setState(() {
        ...
        aps = _CalculateMUTAPS(userMarks);
        isLoading = false;
      });
    } catch (error) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT MUT"),
