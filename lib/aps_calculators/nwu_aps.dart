...
class CalculateApsNWUPage extends StatefulWidget {
  const CalculateApsNWUPage({super.key, required});

  @override
  _CalculateApsNWUPageState createState() => _CalculateApsNWUPageState();
}

class _CalculateApsNWUPageState extends State<CalculateApsNWUPage> {
  ...
  Future<void> _fetchUserMarks() async {
    try {
      ...
      setState(() {
        ...
        aps = _CalculateApsNWU(userMarks);
        isLoading = false;
      });
    } catch (error) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT NWU"),
