...
class CalculateSMUAPSPage extends StatefulWidget {
  const CalculateSMUAPSPage({super.key});

  @override
  _CalculateSMUAPSPageState createState() => _CalculateSMUAPSPageState();
}

class _CalculateSMUAPSPageState extends State<CalculateSMUAPSPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT SMU"),
