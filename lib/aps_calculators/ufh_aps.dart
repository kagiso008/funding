...
class CalculateApsUFHPage extends StatefulWidget {
  const CalculateApsUFHPage({super.key, required});

  @override
  _CalculateApsUFHPageState createState() => _CalculateApsUFHPageState();
}

class _CalculateApsUFHPageState extends State<CalculateApsUFHPage> {
  ...
  Future<void> _fetchUserMarks() async {
    try {
      ...
      setState(() {
        ...
        aps = _CalculateApsUFH(userMarks);
        isLoading = false;
      });
    } catch (error) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT UFH"),
