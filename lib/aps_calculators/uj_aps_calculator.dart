...
class CalculateApsPage extends StatefulWidget {
  const CalculateApsPage({super.key, required});

  @override
  _CalculateApsPageState createState() => _CalculateApsPageState();
}

class _CalculateApsPageState extends State<CalculateApsPage> {
  ...
  int _calculateAps(Map<String, int?> marks) {
    int apsScore = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT UJ"),
