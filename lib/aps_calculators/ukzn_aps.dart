...
class CalculateApsUkznPage extends StatefulWidget {
  const CalculateApsUkznPage({super.key, required});

  @override
  _CalculateApsUkznPageState createState() => _CalculateApsUkznPageState();
}

class _CalculateApsUkznPageState extends State<CalculateApsUkznPage> {
  ...
  Future<void> _fetchUserMarks() async {
    try {
      ...
      setState(() {
        ...
        aps = _CalculateApsUkzn(userMarks);
        isLoading = false;
      });
    } catch (error) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT UKZN"),
