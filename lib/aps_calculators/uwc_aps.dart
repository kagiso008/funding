...
class CalculateApsUWCPage extends StatefulWidget {
  const CalculateApsUWCPage({super.key, required});

  @override
  _CalculateApsUWCPageState createState() => _CalculateApsUWCPageState();
}

class _CalculateApsUWCPageState extends State<CalculateApsUWCPage> {
  ...
  Future<void> _fetchUserMarks() async {
    try {
      ...
      setState(() {
        ...
        aps = _CalculateApsUWC(userMarks);
        isLoading = false;
      });
    } catch (error) {
      setState(() {
...
// Handle Home Language mark
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT UWC"),
