...
class CalculateWSUAPSPage extends StatefulWidget {
  const CalculateWSUAPSPage({super.key});

  @override
  _CalculateWSUAPSPageState createState() => _CalculateWSUAPSPageState();
}

class _CalculateWSUAPSPageState extends State<CalculateWSUAPSPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT WSU"),
          ...
          child: isLoading
              ...
              : Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Card 1: APS Score Without Life Orientation
                      Card(
                        elevation: 8.0,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              const Text(
                                'Your APS Score Without Life Orientation',
                                style: TextStyle(
                                  fontSize: 22,
                      ...
                      // Card 2: APS Score Including Life Orientation
                      Card(
                        elevation: 8.0,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(15.0),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              const Text(
                                'Your APS Score Including Life Orientation incase you want to study Education',
                                style: TextStyle(
                                  fontSize: 22,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.teal,
                              ...
                              const SizedBox(height: 20),
                              Text(
                                apsWithLifeOrientation != null
                                    ? apsWithLifeOrientation.toString()
                                    : 'Error calculating APS',
                                style: const TextStyle(
                                  fontSize: 40,
                                  fontWeight: FontWeight.bold,
                              ...
                              Text(
                                lifeOrientationMark != null
                                    ? 'Life Orientation Mark: $lifeOrientationMark'
                                    : 'No Life Orientation mark available',
                                style: const TextStyle(
                                  fontSize: 18,
                                  color: Color.fromARGB(255, 0, 0, 0),
                                ),
                              ...
                              Text(
                                'Life Orientation APS Points: $lifeOrientationAps',
                                style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black,
