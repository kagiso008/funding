...
class CalculateUZAPSPage extends StatefulWidget {
  const CalculateUZAPSPage({super.key, required});

  @override
  _CalculateUZAPSPageState createState() => _CalculateUZAPSPageState();
}

class _CalculateUZAPSPageState extends State<CalculateUZAPSPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("YOUR APS AT UNI-ZULU"),
