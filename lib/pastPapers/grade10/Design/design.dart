...
class DesignGrade10Page extends StatefulWidget {
  const DesignGrade10Page({super.key});

  @override
  _DesignGrade10PageState createState() => _DesignGrade10PageState();
}

class _DesignGrade10PageState extends State<DesignGrade10Page> {
