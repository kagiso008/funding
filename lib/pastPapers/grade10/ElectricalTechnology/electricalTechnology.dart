...
class ElectricalTechnologyGrade10Page extends StatefulWidget {
  const ElectricalTechnologyGrade10Page({super.key});

  @override
  _ElectricalTechnologyGrade10PageState createState() =>
      _ElectricalTechnologyGrade10PageState();
}

class _ElectricalTechnologyGrade10PageState
    extends State<ElectricalTechnologyGrade10Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_10/ElectricalTechnology');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_10/ElectricalTechnology/$fileName';
