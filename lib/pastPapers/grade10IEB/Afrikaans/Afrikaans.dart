...
class AfrikaansGrade10Page extends StatefulWidget {
  const AfrikaansGrade10Page({super.key});

  @override
  _AfrikaansGrade10PageState createState() => _AfrikaansGrade10PageState();
}

class _AfrikaansGrade10PageState extends State<AfrikaansGrade10Page> {
  ...
  // Method to build PDF list without sorting by paper
  Widget _buildPDFListWithoutPaper(
      List<FileObject> files, String categoryTitle) {
    if (files.isEmpty) {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildPDFListWithoutPaper(hlFiles, 'Home Language (HL)'),
            _buildPDFListWithoutPaper(
                falFiles, 'First Additional Language (FAL)'),
            _buildPDFListWithoutPaper(
                salFiles, 'Second Additional Language (SAL)'),
          ],
        ),
      ),
    );
