...
class IsiNdebeleGrade10Page extends StatefulWidget {
  const IsiNdebeleGrade10Page({super.key});

  @override
  _IsiNdebeleGrade10PageState createState() => _IsiNdebeleGrade10PageState();
}

class _IsiNdebeleGrade10PageState extends State<IsiNdebeleGrade10Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects =
          await supabase.storage.from('pdfs').list(path: 'grade_10/IsiNdebele');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_10/IsiNdebele/$fileName';
