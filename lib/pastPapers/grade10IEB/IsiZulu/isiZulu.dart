...
class IsiZuluGrade10Page extends StatefulWidget {
  const IsiZuluGrade10Page({super.key});

  @override
  _IsiZuluGrade10PageState createState() => _IsiZuluGrade10PageState();
}

class _IsiZuluGrade10PageState extends State<IsiZuluGrade10Page> {
  ...
  // Method to build PDF list without sorting by P1, P2, P3
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // Build lists for HL, FAL, and SAL without sorting by paper
