...
class ReligionStudiesGrade10Page extends StatefulWidget {
  const ReligionStudiesGrade10Page({super.key});

  @override
  _ReligionStudiesGrade10PageState createState() =>
      _ReligionStudiesGrade10PageState();
}

class _ReligionStudiesGrade10PageState
    extends State<ReligionStudiesGrade10Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      // Specify the path to the "ReligionStudiesematics" folder within "grade10"
      final List<FileObject> objects = await supabase.storage
          .from('pdfs')
          .list(path: 'grade_10/ReligionStudies');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      ...
      final String path = 'grade_10/ReligionStudies/$fileName';
