...
class IsiNdebeleGrade11Page extends StatefulWidget {
  const IsiNdebeleGrade11Page({super.key});

  @override
  _IsiNdebeleGrade11PageState createState() => _IsiNdebeleGrade11PageState();
}

class _IsiNdebeleGrade11PageState extends State<IsiNdebeleGrade11Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      final List<FileObject> objects =
          await supabase.storage.from('pdfs').list(path: 'grade_11/IsiNdebele');
  ...
  Future<File?> _downloadPDF(String fileName) async {
    try {
      final String path = 'grade_11/IsiNdebele/$fileName';
