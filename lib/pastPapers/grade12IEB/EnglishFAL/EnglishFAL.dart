...
class EnglishFALGrade12Page extends StatefulWidget {
  ...
  @override
  _EnglishFALGrade12PageState createState() => _EnglishFALGrade12PageState();
}

class _EnglishFALGrade12PageState extends State<EnglishFALGrade12Page> {
    ...
    return Scaffold(
      ...
      body: pdfFiles.isEmpty
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  _buildPDFListByPaper(pdfFiles, 'EnglishFAL Grade 12 Papers'),
                ],
              ),
            ),
    );
