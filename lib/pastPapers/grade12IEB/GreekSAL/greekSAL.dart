...
class GreekSALGrade12Page extends StatefulWidget {
  const GreekSALGrade12Page({super.key});

  @override
  _GreekSALGrade12PageState createState() => _GreekSALGrade12PageState();
}

class _GreekSALGrade12PageState extends State<GreekSALGrade12Page> {
    ...
    return Scaffold(
      ...
      body: pdfFiles.isEmpty
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  _buildPDFListByPaper(pdfFiles, 'Greek SAL Grade 12 Papers'),
                ],
              ),
            ),
    );
