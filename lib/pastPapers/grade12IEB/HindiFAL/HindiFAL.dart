...
class HindiFALGrade12Page extends StatefulWidget {
  const HindiFALGrade12Page({super.key});

  @override
  _HindiFALGrade12PageState createState() => _HindiFALGrade12PageState();
}

class _HindiFALGrade12PageState extends State<HindiFALGrade12Page> {
    ...
    return Scaffold(
      ...
      body: pdfFiles.isEmpty
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  _buildPDFListByPaper(pdfFiles, 'Hindi FAL Grade 12 Papers'),
                ],
              ),
            ),
    );
