...
class HindiSALGrade12Page extends StatefulWidget {
  const HindiSALGrade12Page({super.key});

  @override
  _HindiSALGrade12PageState createState() => _HindiSALGrade12PageState();
}

class _HindiSALGrade12PageState extends State<HindiSALGrade12Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      // Specify the path to the "HindiSALematics" folder within "grade12"
