...
class MandarinSALGrade12Page extends StatefulWidget {
  const MandarinSALGrade12Page({super.key});

  @override
  _MandarinSALGrade12PageState createState() => _MandarinSALGrade12PageState();
}

class _MandarinSALGrade12PageState extends State<MandarinSALGrade12Page> {
  ...
  Future<void> _fetchPDFFiles() async {
    try {
      // Specify the path to the "MandarinSALematics" folder within "grade12"
