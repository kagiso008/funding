...
class TeleguSALGrade12Page extends StatefulWidget {
  const TeleguSALGrade12Page({super.key});

  @override
  _TeleguSALGrade12PageState createState() => _TeleguSALGrade12PageState();
}

class _TeleguSALGrade12PageState extends State<TeleguSALGrade12Page> {
