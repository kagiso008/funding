...
class FrenchSALGrade12Page extends StatefulWidget {
  const FrenchSALGrade12Page({super.key});

  @override
  _FrenchSALGrade12PageState createState() => _FrenchSALGrade12PageState();
}

class _FrenchSALGrade12PageState extends State<FrenchSALGrade12Page> {
    ...
    return Scaffold(
      ...
      body: pdfFiles.isEmpty
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  _buildPDFListByPaper(pdfFiles, 'French SAL Grade 12 Papers'),
                ],
              ),
            ),
    );
