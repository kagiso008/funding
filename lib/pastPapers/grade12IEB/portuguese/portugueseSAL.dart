...
class PortugueseSALGrade12Page extends StatefulWidget {
  const PortugueseSALGrade12Page({super.key});

  @override
  _PortugueseSALGrade12PageState createState() =>
      _PortugueseSALGrade12PageState();
}

class _PortugueseSALGrade12PageState extends State<PortugueseSALGrade12Page> {
              ...
              child: Column(
                children: [
                  _buildPDFListByPaper(
                      pdfFiles, 'PortugueseSAL Grade 12 Papers'),
                ],
              ),
            ),
    );
